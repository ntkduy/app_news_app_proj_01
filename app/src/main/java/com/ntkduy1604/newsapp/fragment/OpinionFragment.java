...
public class OpinionFragment extends Fragment
    ...
    {
    private static final String TAG = "OpinionFragment";
    @BindString(R.string.no_internet_connection) String NO_CONNECTION;
    @BindString(R.string.nav_opinion) String sectionName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(isConnected) {
            ...
            loaderManager.initLoader(Constants.OPINION_LOADER_ID, null, this);
        } else {
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        if (key.equals(settingsEditionKey) | key.equals(settingsOrderByKey)){
            ...
            LoaderManager loaderManager = getActivity().getLoaderManager();
            loaderManager.restartLoader(Constants.OPINION_LOADER_ID, null, this);
        }
    }
    ...
    public Loader<List<Article>> onCreateLoader(int i, Bundle bundle) {
        ...
        uriBuilder.appendQueryParameter(Constants.API_SECTION, Constants.OPINION_SECTION);
