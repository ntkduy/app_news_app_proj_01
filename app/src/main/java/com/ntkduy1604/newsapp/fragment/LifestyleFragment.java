...
public class LifestyleFragment extends Fragment
    ...
    @BindString(R.string.nav_lifestyle) String sectionName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(isConnected) {
            ...
            loaderManager.initLoader(Constants.LIFESTYLE_LOADER_ID, null, this);
        } else {
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        if (key.equals(settingsEditionKey) | key.equals(settingsOrderByKey)){
            ...
            LoaderManager loaderManager = getActivity().getLoaderManager();
            loaderManager.restartLoader(Constants.LIFESTYLE_LOADER_ID, null, this);
        }
    }
    ...
    public Loader<List<Article>> onCreateLoader(int i, Bundle bundle) {
        ...
        uriBuilder.appendQueryParameter(Constants.API_SECTION, Constants.LIFESTYLE_SECTION);
